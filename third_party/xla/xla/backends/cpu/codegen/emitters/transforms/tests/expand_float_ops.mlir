...
func.func @cbrt_vector(%arg0: vector<8xf64>) -> vector<8xf64> {
  %ret = math.cbrt %arg0 : vector<8xf64>
...
// CHECK: %[[ABS:.*]] = math.absf %[[ARG]] : vector<8xf64>
// CHECK: %[[CBRT_ABS:.*]] = math.powf %[[ABS]], %[[CONSTANT]] : vector<8xf64>
// CHECK: %[[CBRT_SIGNED:.*]] = math.copysign %[[CBRT_ABS]], %[[ARG]] : vector<8xf64>
// CHECK: return %[[CBRT_SIGNED]]
