...
// CHECK: @truncf_f32_to_fp8e4m3fn_no_rounding_mode_falls_back_to_arith(%[[ARG0:.*]]: tensor<32xf32>) -> tensor<32xf8E4M3FN>
func.func @truncf_f32_to_fp8e4m3fn_no_rounding_mode_falls_back_to_arith(%arg0: tensor<32xf32>) -> tensor<32xf8E4M3FN> {
  // CHECK: arith.truncf %[[ARG0]] : tensor<32xf32> to tensor<32xf8E4M3FN>
