...
ENTRY test_computation {
  ...
  std::unique_ptr<CollectivePermuteStartThunk> cp_start_thunk =
      std::make_unique<CollectivePermuteStartThunk>(
  ...
  std::unique_ptr<CollectiveDoneThunk> cp_done_thunk =
      std::make_unique<CollectiveDoneThunk>(
